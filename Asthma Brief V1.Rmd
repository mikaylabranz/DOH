...
asthma %>% 
  ...
  ggtitle("Asthma Hospitalization Cases per 10,000 people per month, by Race, 2019")
...
asthma %>% 
  ...
  scale_fill_manual(values = c("darkorchid4","turquoise4", "#02075d")) +
  scale_y_continuous(expand = c(0,0), limits = c(0,11)) +
  ggtitle("Asthma Hospitalization Cases per 10,000 people per month, by Race, 2020")
...
AsthmaRaceRate %>% 
  ggplot() +
  geom_col(aes(x = RaceCondensed, y=total, fill = Year), position = "dodge") +
  labs(y="Cases", x = "Race") +
   theme(axis.text.x=element_text(angle=45,  hjust = 1)) +
   theme(panel.grid.minor.x=element_blank())+
   scale_fill_manual(values = c("darkorchid4","turquoise4", "#02075d")) +
    scale_y_continuous(expand = c(0,0), limits = c(0,11)) +
  ggtitle("Asthma Hospitalization Cases per 10,000 people per month, by Race, 2019 and 2020")

class(asthma$AgeGroup)
asthma$AgeGroup <-as.factor(asthma$AgeGroup)
#Check on asthma hospitalizations in 2020- do they drop off w/ covid?
asthma %>% 
  filter(Year == 2020) %>% 
  ...
  labs(y="Cases", x = "Month", color = "Race") +
   ...
   theme(panel.grid.minor.x=element_blank())+
  ggtitle("Asthma Hospitalization Cases by Month, 2020")

#Check on asthma hospitalizations in 2020 for children- do they drop off w/ covid?
asthma %>% 
  ...
  labs(y="Cases", x = "Month", color = "Race") +
   theme(axis.text.x=element_text(angle=45,  hjust = 1)) +
    scale_x_continuous(breaks = seq(0,8, by =1))+
   theme(panel.grid.minor.x=element_blank())+
  ggtitle("0-9 year olds Asthma Hospitalization Cases by Month, 2020")

#Check on asthma hospitalizations in 2019 for comparison
asthma %>% 
  ...
  labs(y="Cases", x = "Month", color = "Race") +
   ...
   theme(panel.grid.minor.x=element_blank())+
  facet_grid(~ Year) +
  ggtitle("Asthma Hospitalization Cases by Month, 2019")

#Check on asthma hospitalizations in 2019 of kids 0-9 for comparison
asthma %>% 
  filter(Year == 2019) %>% 
  group_by(RaceCondensed, Month) %>% 
  summarise(total = n()) %>% 
  ...
  labs(y="Cases", x = "Month", color = "Race") +
   theme(axis.text.x=element_text(angle=45,  hjust = 1)) +
    scale_x_continuous(breaks = seq(0,12, by =1))+
   theme(panel.grid.minor.x=element_blank())+
  ggtitle("0-9 Year olds Asthma Hospitalization Cases by Month, 2019")

##change hospitalization to "ER visits", data source = essence. "preliminary"
...
asthma %>% 
  ...
  summarise(total = n()) 
#There aren't really enough Latinx cases to be able to look at this as a proportion? could try
...
summarise(total = n()) %>% 
  ...
  ggtitle("Asthma Hospitalization Cases by Age Group, Jan.-Dec. 2019")
...
summarise(total = n()) %>% 
 ...
 scale_y_continuous(expand = c(0,0), limits=c(0,200)) +
  ggtitle("Asthma Hospitalization Cases by Age Group, Jan.-Aug 2020")
...
asthma %>% 
  ...
  labs(y="Cases", x = "Year", color = "Ethnicity") +
   theme(axis.text.x=element_text(angle=45,  hjust = 1)) +
    scale_x_continuous(breaks = seq(2014,2020, by =1))+
   theme(panel.grid.minor.x=element_blank())+
  ggtitle("Asthma Hospitalization Cases per 10,000 people per month, by Ethnicity, 2014-2020")
...
asthma %>% 
  ...
  labs(y="Cases", x = "Year", color = "Race") +
   theme(axis.text.x=element_text(angle=45,  hjust = 1)) +
    scale_x_continuous(breaks = seq(2014,2020, by =1))+
   theme(panel.grid.minor.x=element_blank())+
  ggtitle("Asthma Hospitalization Cases per 10,000 people per month, by Race, 2014-2020")
